...
//RUN CODE HERE :
    ...
    /* Opens a window that will load the new_url 
    ...
    public void start(Stage stage) {
        ...
        newBrowserWindow("https://rajmulik511.github.io/rajportfoilo.io/");
     ...
     * used.  A new window that is opened with a null new_url gets a title of
    ...
    /**
     * Open a new browser window.  If new_url is non-null, the window will load that new_url.
     * A package-private method that is meant for use only in BrowserWindow.java.
     ...
     */
    void newBrowserWindow(String new_url) {
        BrowserWindow window = new BrowserWindow(this,new_url);
